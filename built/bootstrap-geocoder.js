(function (global, factory) {
  ...
  (global = global || self, factory((global.L = global.L || {}, global.L.esri = global.L.esri || {}, global.L.esri.BootstrapGeocoder = {}), global.L));
  ...
  function _getAttributionData (url, map) {
    if (Support.cors) {
      request(url, {}, L$1.Util.bind(function (error, attributions) {
        if (error) { return; }
  ...
  var Task = L$1.Class.extend({
    ...
    request: function (callback, context) {
      if (this.options.requestParams) {
        L$1.Util.extend(this.params, this.options.requestParams);
      }
      if (this._service) {
  ...
  var Service = L$1.Evented.extend({
    ...
    _request: function (method, path, params, callback, context) {
      ...
      if (this.options.requestParams) {
        L$1.Util.extend(params, this.options.requestParams);
      }
  ...
  function _fetchTilemap (evt) {
    ...
    if (newZoom > oldZoom && newZoom > 13 && !this.options.downsampled) {
      ...
      var tileUrl = L$1.Util.template(this._url, L$1.Util.extend({
  ...
  var TiledMapLayer = L$1.TileLayer.extend({
    ...
    initialize: function (options) {
      ...
      this.tileUrl = (options.proxy ? options.proxy + '?' : '') + options.url + 'tile/{z}/{y}/{x}' + (options.requestParams && Object.keys(options.requestParams).length > 0 ? L$1.Util.getParamString(options.requestParams) : '');
    ...
    createTile: function (coords, done) {
      ...
      L$1.DomEvent.on(tile, 'load', L$1.Util.bind(this._tileOnLoad, this, done, tile));
      L$1.DomEvent.on(tile, 'error', L$1.Util.bind(this._tileOnError, this, done, tile));
      ...
      if (!this._lodMap) {
        this.metadata(function (error, metadata) {
          if (!error && metadata.spatialReference) {
            ...
            if (map.options.crs === L$1.CRS.EPSG3857 && (sr === 102100 || sr === 3857)) {
              this._lodMap = {};
  ...
  var VirtualGrid = L$1.Layer.extend({
    ...
    _isValidCell: function (coords) {
      ...
      return L$1.latLngBounds(this.options.bounds).intersects(cellBounds);
    },
    ...
    _wrapCoords: function (coords) {
      coords.x = this._wrapLng ? L$1.Util.wrapNum(coords.x, this._wrapLng) : coords.x;
      coords.y = this._wrapLat ? L$1.Util.wrapNum(coords.y, this._wrapLat) : coords.y;
    },
  ...
  var FeatureManager = VirtualGrid.extend({
    ...
    _buildQuery: function (bounds) {
      ...
      if (this.options.requestParams) {
        L$1.Util.extend(query.params, this.options.requestParams);
      }
    ...
    addFeatures: function (features, callback, context) {
      this._getMetadata(L$1.Util.bind(function (error, metadata) {
        ...
        this.service.addFeatures(features, L$1.Util.bind(function (error, response) {
          if (!error) {
            for (var i = featuresArray.length - 1; i >= 0; i--) {
  ...
  var FeatureLayer = FeatureManager.extend({
    ...
    resetFeatureStyle: function (id) {
      var layer = this._layers[id];
      var style = this._originalStyle || L$1.Path.prototype.options;
      if (layer) {
  ...
  var Geocode = Task.extend({
    ...
    within: function (bounds) {
      bounds = L$1__default.latLngBounds(bounds);
      this.params.bbox = EsriUtil.boundsToExtent(bounds);
      return this;
    },

    nearby: function (latlng, radius) {
      latlng = L$1__default.latLng(latlng);
    ...
    _processFindResponse: function (response) {
      ...
      for (var i = 0; i < response.locations.length; i++) {
        ...
        if (location.extent) {
          bounds = EsriUtil.extentToBounds(location.extent);
        }
        ...
        results.push({
          ...
          latlng: L$1__default.latLng(location.feature.geometry.y, location.feature.geometry.x),
    ...
    _processFindAddressCandidatesResponse: function (response) {
      ...
      for (var i = 0; i < response.candidates.length; i++) {
        ...
        results.push({
          ...
          latlng: L$1__default.latLng(candidate.location.y, candidate.location.x),
  ...
  var ReverseGeocode = Task.extend({
    ...
    run: function (callback, context) {
      return this.request(function (error, response) {
        ...
        if (!error) {
          result = {
            latlng: L$1__default.latLng(response.location.y, response.location.x),
  ...
  var GeosearchCore = L$1__default.Evented.extend({
    ...
    initialize: function (control, options) {
      L$1__default.Util.setOptions(this, options);
    ...
    _geocode: function (text, key, provider) {
      ...
      var callback = L$1__default.Util.bind(function (error, results) {
        activeRequests--;
        if (error) {
          return;
        }
    ...
    _suggest: function (text) {
      ...
      var createCallback = L$1__default.Util.bind(function (text, provider) {
        return L$1__default.Util.bind(function (error, suggestions) {
          if (error) { return; }
    ...
    _boundsFromResults: function (results) {
      ...
      var nullIsland = L$1__default.latLngBounds([0, 0], [0, 0]);
      var resultBounds = [];
      var resultLatlngs = [];
      ...
      var bounds = L$1__default.latLngBounds(resultLatlngs);
  ...
  var Geosearch = L$1__default.Control.extend({
    includes: L$1__default.Mixin.Events,
    ...
    initialize: function (options) {
      ...
      L$1__default.Control.prototype.initialize.call(options);
    },
    ...
    _renderSuggestions: function (suggestions) {
      ...
      for (var i = 0; i < suggestions.length; i++) {
        ...
        if (!header && this._geosearchCore._providers.length > 1 && currentGroup !== suggestion.provider.options.label) {
          header = L$1__default.DomUtil.create('span', 'geocoder-control-header', this._suggestions);
        ...
        if (!list) {
          list = L$1__default.DomUtil.create('ul', 'geocoder-control-list', this._suggestions);
        }

        var suggestionItem = L$1__default.DomUtil.create('li', 'geocoder-control-suggestion', list);
      ...
      L$1__default.DomUtil.removeClass(this._input, 'geocoder-control-loading');
    ...
    clear: function () {
      ...
      if (this.options.collapseAfterResult) {
        ...
        L$1__default.DomUtil.removeClass(this._wrapper, 'geocoder-control-expanded');
      }
    ...
    _setupClick: function () {
      L$1__default.DomUtil.addClass(this._wrapper, 'geocoder-control-expanded');
      this._input.focus();
    },

    disable: function () {
      this._input.disabled = true;
      L$1__default.DomUtil.addClass(this._input, 'geocoder-control-input-disabled');
      L$1__default.DomEvent.removeListener(this._wrapper, 'click', this._setupClick, this);
    },

    enable: function () {
      this._input.disabled = false;
      L$1__default.DomUtil.removeClass(this._input, 'geocoder-control-input-disabled');
      L$1__default.DomEvent.addListener(this._wrapper, 'click', this._setupClick, this);
    },
    ...
    onAdd: function (map) {
      ...
      this._map = map;
      this._wrapper = L$1__default.DomUtil.create('div', 'geocoder-control ' + ((this.options.expanded) ? ' ' + 'geocoder-control-expanded' : ''));
      this._input = L$1__default.DomUtil.create('input', 'geocoder-control-input leaflet-bar', this._wrapper);
      this._input.title = this.options.title;

      this._suggestions = L$1__default.DomUtil.create('div', 'geocoder-control-suggestions leaflet-bar', this._wrapper);

      var credits = this._geosearchCore._getAttribution();
      map.attributionControl.addAttribution(credits);

      L$1__default.DomEvent.addListener(this._input, 'focus', function (e) {
      ...
      L$1__default.DomEvent.addListener(this._suggestions, 'mousedown', function (e) {
        var suggestionItem = e.target || e.srcElement;
        this._geosearchCore._geocode(suggestionItem.innerHTML, suggestionItem['data-magic-key'], suggestionItem.provider);
        this.clear();
      }, this);

      L$1__default.DomEvent.addListener(this._input, 'blur', function (e) {
        this.clear();
      }, this);

      L$1__default.DomEvent.addListener(this._input, 'keydown', function (e) {
        L$1__default.DomUtil.addClass(this._wrapper, 'geocoder-control-expanded');
        ...
        switch (e.keyCode) {
          case 13:
            if (selected) {
              ...
              L$1__default.DomUtil.addClass(list[0], 'geocoder-control-selected');
            }
            L$1__default.DomEvent.preventDefault(e);
            break;
          case 38:
            if (selected) {
              L$1__default.DomUtil.removeClass(selected, 'geocoder-control-selected');
            }

            var previousItem = list[selectedPosition - 1];

            if (selected && previousItem) {
              L$1__default.DomUtil.addClass(previousItem, 'geocoder-control-selected');
            } else {
              L$1__default.DomUtil.addClass(list[list.length - 1], 'geocoder-control-selected');
            }
            L$1__default.DomEvent.preventDefault(e);
            break;
          case 40:
            ...
            if (selected && nextItem) {
              L$1__default.DomUtil.addClass(nextItem, 'geocoder-control-selected');
            } else {
              L$1__default.DomUtil.addClass(list[0], 'geocoder-control-selected');
            }
            L$1__default.DomEvent.preventDefault(e);
      ...
      L$1__default.DomEvent.addListener(this._input, 'keyup', L$1__default.Util.throttle(function (e) {
        ...
        if (key !== 13 && key !== 38 && key !== 40) {
          if (this._input.value !== this._lastValue) {
            ...
            L$1__default.DomUtil.addClass(this._input, 'geocoder-control-loading');
            this._geosearchCore._suggest(text);
          }
        }
      }, 50, this), this);

      L$1__default.DomEvent.disableClickPropagation(this._wrapper);

      // when mouse moves over suggestions disable scroll wheel zoom if its enabled
      L$1__default.DomEvent.addListener(this._suggestions, 'mouseover', function (e) {
      ...
      L$1__default.DomEvent.addListener(this._suggestions, 'mouseout', function (e) {
        if (!map.scrollWheelZoom.enabled() && map.options.scrollWheelZoom) {
  ...
  var FeatureLayerProvider = FeatureLayerService.extend({
    ...
    results: function (text, key, bounds, callback) {
      ...
      return query.run(L$1__default.Util.bind(function (error, features) {
        var results = [];
    ...
    _featureBounds: function (feature) {
      var geojson = L$1__default.geoJson(feature);
      if (feature.geometry.type === 'Point') {
        var center = geojson.getBounds().getCenter();
        var lngRadius = ((this.options.bufferRadius / 40075017) * 360) / Math.cos((180 / Math.PI) * center.lat);
        var latRadius = (this.options.bufferRadius / 40075017) * 360;
        return L$1__default.latLngBounds([center.lat - latRadius, center.lng - lngRadius], [center.lat + latRadius, center.lng + lngRadius]);
      } else {
  ...
  var MapServiceProvider = MapService.extend({
    ...
    _layerMetadataCallback: function (layerid) {
      return L$1__default.Util.bind(function (error, metadata) {
        if (error) { return; }
  ...
  var Search = L$1__default.Layer.extend({
    ...
    _renderSuggestions: function (suggestions) {
      ...
      for (var i = 0; i < suggestions.length; i++) {
        ...
        if (!list) {
          list = L$1__default.DomUtil.create('ul', null, this._suggestions);
    ...
    onAdd: function (map) {
      ...
      L$1__default.DomUtil.addClass(this._wrapper, this.options.wrapperStyle);
      ...
      L$1__default.DomUtil.addClass(this._suggestions, this.options.suggestionGroupStyle);
        ...
        switch (e.keyCode) {
          case 13:  // enter
            if (selected) {
              ...
              L$1__default.DomUtil.addClass(list[0], selectedStyle);
            }
            L$1__default.DomEvent.preventDefault(e);
            break;
          case 38: // up arrow
            if (selected) {
              L$1__default.DomUtil.removeClass(selected, selectedStyle);
            }

            var previousItem = list[selectedPosition - 1];

            if (selected && previousItem) {
              L$1__default.DomUtil.addClass(previousItem, selectedStyle);
            } else {
              L$1__default.DomUtil.addClass(list[list.length - 1], selectedStyle);
            }
            L$1__default.DomEvent.preventDefault(e);
            break;
          case 40: // down arrow
            ...
            if (selected && nextItem) {
              L$1__default.DomUtil.addClass(nextItem, selectedStyle);
            } else {
              L$1__default.DomUtil.addClass(list[0], selectedStyle);
            }
            L$1__default.DomEvent.preventDefault(e);
